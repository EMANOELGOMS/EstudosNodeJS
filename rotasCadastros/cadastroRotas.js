...
const routerCadastro = express(); // o express é chamado para criar a aplicação

//routerCadastro.use(bodyParser.json())

routerCadastro.use(express.json())
routerCadastro.use(express.urlencoded({ extended: true })) //está função está sendo usada para permitir que os dados sejam enviados através app.use
...
routerCadastro.get('/cadastros/todos', (req,res) =>{
    console.log(req)
    res.json(cadastros)
    })
...
routerCadastro.get('/cadastro/:id', (req, res) =>{// :id  é um parametro dinamico que vai ser substituido pelo valor da urlapp.use(express.json()); 
...
routerCadastro.post('/cadastro', (req,res)=>{
...
routerCadastro.get('/cadastros/idade/:idade', (req, res)=>{
...
routerCadastro.get('/cadastros/nome/:nome', (req, res)=>{
...
routerCadastro.get('/cadastros/cidades/:cidade', (req,res)=> {
